...
CREATE INDEX IF NOT EXISTS idx_synonym_trgm ON public.concept_synonym USING gin (concept_synonym_name gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_concept_name_trgm ON public.concept USING gin (concept_name gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_concept_code ON public.concept (vocabulary_id, concept_code);
CREATE INDEX IF NOT EXISTS idx_concept_domain ON public.concept (domain_id, standard_concept);
