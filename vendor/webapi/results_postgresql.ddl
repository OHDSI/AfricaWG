CREATE TABLE IF NOT EXISTS cdm_results.achilles_result_concept_count  (concept_id                int,
  record_count              bigint,
  descendant_record_count   bigint,
  person_count              bigint,
  descendant_person_count   bigint
);CREATE TABLE IF NOT EXISTS cdm_results.cohort
 (COHORT_DEFINITION_ID int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cc_results
...
CREATE TABLE IF NOT EXISTS cdm_results.cc_temporal_results (type                 varchar(255),
  fa_type              varchar(255),
...
CREATE TABLE IF NOT EXISTS cdm_results.cc_temporal_annual_results (type                 varchar(255),
      fa_type              varchar(255),
      cc_generation_id     bigint,
      analysis_id          integer,
      analysis_name        varchar(1000),
      ...
      cohort_definition_id bigint,
      event_year           integer
);CREATE TABLE IF NOT EXISTS cdm_results.cohort_inclusion (cohort_definition_id int NOT NULL,
  design_hash int NULL,
  rule_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_inclusion_result (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.cohort_sample_element (cohort_sample_id int NOT NULL,
    rank_value int NOT NULL,
    person_id bigint NOT NULL,
    age int,
    gender_concept_id int
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);
...
/*********************************************************************/
CREATE TABLE IF NOT EXISTS cdm_results.concept_hierarchy
 (concept_id             INT,
...
CREATE TABLE IF NOT EXISTS cdm_results.feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.heracles_analysis
 (analysis_id int,
...
CREATE TABLE IF NOT EXISTS cdm_results.heracles_periods
 (period_id int,
  period_order int,
...
CREATE TABLE IF NOT EXISTS cdm_results.heracles_results
 (cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
--HINT BUCKET(analysis_id, 64)
CREATE TABLE IF NOT EXISTS cdm_results.heracles_results_dist
 (cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
	stratum_2 varchar(255),
...
CREATE TABLE IF NOT EXISTS cdm_results.ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);
CREATE TABLE IF NOT EXISTS cdm_results.pathway_analysis_codes
 (pathway_analysis_generation_id BIGINT NOT NULL,
	code BIGINT NOT NULL,
	name VARCHAR(2000) NOT NULL,
	is_combo int NOT NULL
);CREATE TABLE IF NOT EXISTS cdm_results.pathway_analysis_events
 (pathway_analysis_generation_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm_results.pathway_analysis_paths
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
  step_2 BIGINT,
...
);CREATE TABLE IF NOT EXISTS cdm_results.pathway_analysis_stats
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
TRUNCATE TABLE cdm_results.heracles_analysis;
insert into cdm_results.heracles_analysis
...
/***********************************************************/
TRUNCATE TABLE cdm_results.concept_hierarchy;
...
ANALYZE temp_period
;
TRUNCATE TABLE cdm_results.heracles_periods;
INSERT INTO cdm_results.heracles_periods (period_id, period_name, period_order, period_type, period_start_date, period_end_date)
...
CREATE INDEX HRD_IDX_COHORT_DEF_ID ON cdm_results.HERACLES_RESULTS_DIST (cohort_definition_id);
CREATE INDEX HRD_IDX_COHORT_ID_ANALYSIS_ID ON cdm_results.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);
CREATE INDEX HRD_IDX_COHORT_DEF_ID_DT ON cdm_results.HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);
CREATE INDEX HRD_IDX_COHORT_ID_FIRST_RES ON cdm_results.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);
CREATE INDEX HR_IDX_COHORT_DEF_ID ON cdm_results.HERACLES_RESULTS (cohort_definition_id);
CREATE INDEX HR_IDX_COHORT_ID_ANALYSIS_ID ON cdm_results.HERACLES_RESULTS (cohort_definition_id, analysis_id);
CREATE INDEX HR_IDX_COHORT_ANALYSIS_CONCEPT ON cdm_results.HERACLES_RESULTS (cohort_definition_id, analysis_id) WHERE stratum_2 <> '';
CREATE INDEX HR_IDX_COHORT_DEF_ID_DT ON cdm_results.HERACLES_RESULTS (cohort_definition_id, last_update_time);
CREATE INDEX HR_IDX_COHORT_ID_FIRST_RES ON cdm_results.HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);
CREATE INDEX HH_IDX_COHORT_ID_ANALYSIS_ID ON cdm_results.HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);
CREATE INDEX idx_heracles_periods_startdate ON cdm_results.heracles_periods (period_start_date);
CREATE INDEX idx_heracles_periods_end_date ON cdm_results.heracles_periods (period_end_date);
CREATE INDEX idx_cohort_sample_element_rank ON cdm_results.cohort_sample_element (cohort_sample_id, rank_value);CREATE TABLE IF NOT EXISTS cdm_results.feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);
CREATE INDEX idx_pathway_events_combo_id ON cdm_results.pathway_analysis_events (combo_id);
